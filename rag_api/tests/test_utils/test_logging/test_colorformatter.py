...
import click
import logging
from app.app.utils.logging import ColorFormatter, request_msg_format
...
class TestColorFormatter:
    ...
    @mock.patch("app.app.utils.logging.click.style",
    ...
    @mock.patch("app.app.utils.logging.logging.Formatter")
