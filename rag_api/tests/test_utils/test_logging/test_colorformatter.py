...
import click
import logging
from rag_api.app.utils.logging import ColorFormatter, request_msg_format
...
class TestColorFormatter:
    ...
    @mock.patch("rag_api.app.utils.logging.click.style",
    ...
    @mock.patch("rag_api.app.utils.logging.logging.Formatter")
