...
NAME = 'rag_api'
SHORT_DESCRIPTION = "'retrieval augmented chat bot'"
URL = "https://github.com/YuliaGoryachev/chat_bot_RAG"
AUTHOR = 'Yulia Goryachev'
EMAIL = 'ygenis@gmail.com'
...
setup(name=NAME,
      ...
      url=URL,
      packages=find_packages(include=["rag_api*"],
